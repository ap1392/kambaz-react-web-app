    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          ...
          <li>
            Mix 2 1/4 cups flour, 1/2 tsp baking soda, and 1/2 tsp salt in a
            bowl.
          </li>
          <li>
            Cream 1 cup butter, 3/4 cup granulated sugar, 3/4 cup brown sugar, 2
            eggs, and 1 tsp vanilla. Combine with dry ingredients.
          </li>
          <li>
            Fold in 2 cups chocolate chips, scoop dough onto the baking sheet,
            and space evenly.
          </li>
          <li>Bake for 10-12 minutes, cool for 5 minutes, and enjoy!</li>
        </ol>
      </div>
